...
?>
    ...
    <div data-role="page" id="page-login" data-unload="false">
        ...
        <div data-role="main" class="ui-content">
            <p>Welcome to the OV Rally game!</p>
            <br />
            <p>Please select your team and provide your password to login.</p><br />

            <form method="POST" action="login.php">
                <select name="team_id" id="team-id" title="Team">
                    <option value="" selected="selected">Select your team...</option>
                    <?php

                    // Get the list of teams
                    $teams = TeamManager::getTeams();

                    // Put each team into the list
                    foreach($teams as $team) {
                        // Verify the instance
                        if(!($team instanceof Team))
                            continue;

                        // Put the team into the list
                ...
                <div id="login-input-container" style="padding-top: 1px;">
                    <input type="password" name="team_pass" id="team-pass" value="" placeholder="Password" /><br />

                    <input type="submit" id="team-submit" value="Login" class="ui-btn ui-icon-lock ui-btn-icon-right" />
                </div>
            </form>
        </div>
